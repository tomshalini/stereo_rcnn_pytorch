...
class kitti(imdb):
    ...
    def _load_kitti_annotation(self,index):
        if self._image_set == 'test':
            ...
            position=  np.zeros((num_objs, 4), dtype=np.float32)            #shaliniiiiiiiiiiiiii
            ...
            for i in range(len(objects)):
                ...
                gt_classes[i] = cls
                overlaps[i, cls] = 1.0
                position[i,4] =objects[i].pos                    # shaliniiiiiiiiiiiiiiiiiiiiiiiiiiiii
                print("testing kitty.py dimension printinggggggggggggggg", dim_orien)
            ...
            print("shaliniiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii")
