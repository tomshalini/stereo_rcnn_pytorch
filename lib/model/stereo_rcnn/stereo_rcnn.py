...
class _StereoRCNN(nn.Module):
    ...
    def forward(self, im_left_data, im_right_data, im_info, gt_boxes_left, gt_boxes_right,\
        ...
        '''print("imleftdata is",im_left_data.shape)
        print("im_right_data is", im_right_data.shape)
        print("im_info is", im_info.shape)
        print("gt_boxes_left is", gt_boxes_left.shape)
        print("gt_boxes_right is", gt_boxes_right.shape)
        print("gt_boxes_merge is", gt_boxes_merge.shape)
        print("gt_dim_orien is", gt_dim_orien.shape)
        print("gt_kpts is", gt_kpts.shape)
        print("num_boxes is", num_boxes.shape)
        exit(0)'''
        ...
        rois_left, rois_right, rpn_loss_cls, rpn_loss_bbox_left_right = \
            self.RCNN_rpn(rpn_feature_maps_left, rpn_feature_maps_right, im_info, gt_boxes_left, gt_boxes_right, gt_boxes_merge, num_boxes)
